...
if(isset($_POST['submit'])){
    ...
    if(empty($customer_name) OR empty($adult_number) OR empty($child_num) OR empty($change) OR empty($total) OR empty($sold_date)){
        ...
        <script>
            ...
            window.location.href='../foreigner_ticket.php';
        </script>
    ";
    }else{
        $sql = "INSERT INTO foreigner_ticket (customer_name, num_of_adults, num_of_children, ticket_for, total_cost, customer_change, sold_date)
