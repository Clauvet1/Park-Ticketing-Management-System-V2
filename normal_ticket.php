...
<body>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-8">
        <div class="manage_ticket_content">
            <h1 class="hs mt-3">Normal Ticket</h1>
            <hr class="h">

            <form action="includes/n_ticket.php" method="POST">
                <div class="form_box">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="lab">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 text-center">
                            <h1 class="text-success shadow">Citizen Ticket</h1>
                        </div>
                    </div>
                    <hr>
    ...
    <?php
            $sql = "SELECT* FROM manage_ticket WHERE nationality = 'citizen';";
